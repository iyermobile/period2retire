...
sidebarLayout(position="right",
	sidebarPanel(
		...
		helpText("Idea and original code by Pierre Chretien, updated by Michael Kapler, and then Lin Crampton. Source at https://github.com/iyermobile/period2retire. Comments/complaints to iyermobile@gmail.com") 
	), #sidebarPanel
